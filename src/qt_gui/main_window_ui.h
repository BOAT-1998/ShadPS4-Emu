...
public:
    ...
    void setupUi(QMainWindow* MainWindow) {
        ...
        installFirmwareAct = new QAction(MainWindow);
        installFirmwareAct->setObjectName("installFirmwareAct");
        installFirmwareAct->setIcon(QIcon(":images/update_icon.png"));
        ...
        showGameLogAct = new QAction(MainWindow);
        showGameLogAct->setObjectName("showGameLogAct");
        showGameLogAct->setCheckable(true);
        showGameLogAct->setChecked(true);
        ...
        menuFile->addAction(installFirmwareAct);
        ...
        menuView->addAction(showGameLogAct);
    ...
    void retranslateUi(QMainWindow* MainWindow) {
        ...
        installFirmwareAct->setText(
            QCoreApplication::translate("MainWindow", "Install Firmware...", nullptr));
#ifdef ENABLE_UPDATER
        updaterAct->setText(
...
#if QT_CONFIG(tooltip)
        installFirmwareAct->setToolTip(
            QCoreApplication::translate("MainWindow", "Install PS4 firmware (PUP or folder)",
                                        nullptr));
#endif // QT_CONFIG(tooltip)
        ...
        showGameLogAct->setText(
            QCoreApplication::translate("MainWindow", "Show Game Log", nullptr));
