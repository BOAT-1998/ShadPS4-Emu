...
QPixmap WindowThemes::CreateThemeBackground(Theme theme, const QSize& size) const {
    QSize targetSize = size.isValid() ? size : QSize(1280, 720);
    QPixmap pixmap(targetSize);
    QLinearGradient gradient(QPointF(0, 0), QPointF(0, targetSize.height()));
    ...
    case Theme::Light:
        ...
        break;
    case Theme::Green:
        gradient.setColorAt(0.0, QColor(30, 46, 30));
        gradient.setColorAt(1.0, QColor(17, 28, 20));
        break;
    case Theme::Blue:
        gradient.setColorAt(0.0, QColor(25, 43, 63));
        gradient.setColorAt(1.0, QColor(9, 17, 28));
        break;
    case Theme::Violet:
        gradient.setColorAt(0.0, QColor(70, 30, 80));
        gradient.setColorAt(1.0, QColor(30, 10, 40));
        break;
    case Theme::Gruvbox:
        gradient.setColorAt(0.0, QColor(29, 32, 33));
        gradient.setColorAt(1.0, QColor(50, 48, 47));
        break;
    case Theme::TokyoNight:
        gradient.setColorAt(0.0, QColor(26, 28, 40));
        gradient.setColorAt(1.0, QColor(13, 15, 22));
        break;
    case Theme::Oled:
    ...
    case Theme::Dark:
    default:
        gradient.setColorAt(0.0, QColor(38, 38, 38));
