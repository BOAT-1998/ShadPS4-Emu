...
void setShowBootScreen(bool enable, bool is_game_specific = false);
...
void setResolutionScale(int scale, bool is_game_specific = false);
std::string getGraphicsProfile();
void setGraphicsProfile(const std::string& profile, bool is_game_specific = false);
std::string getTextureQuality();
void setTextureQuality(const std::string& quality, bool is_game_specific = false);
int getAnisotropicLevel();
void setAnisotropicLevel(int level, bool is_game_specific = false);
bool getEnableFxaa();
void setEnableFxaa(bool enable, bool is_game_specific = false);
bool getEnableSharpen();
void setEnableSharpen(bool enable, bool is_game_specific = false);
int getFrameLimit();
void setFrameLimit(int fps, bool is_game_specific = false);
bool getShaderPreloadCache();
void setShaderPreloadCache(bool enable, bool is_game_specific = false);
bool getAsyncShaderCompile();
void setAsyncShaderCompile(bool enable, bool is_game_specific = false);
bool getEnableMtRendering();
void setEnableMtRendering(bool enable, bool is_game_specific = false);
void AutoTuneFromHardware(bool is_game_specific = false);
