...
public:
    ...
    void SetPredication(const AmdGpu::Liverpool::PredicationState& state);
...
private:
    ...
    bool FilterDraw();
    bool BeginConditionalRendering();
    void EndConditionalRendering(bool active);
...
private:
    ...
    AmdGpu::Liverpool::PredicationState predication{};
};
